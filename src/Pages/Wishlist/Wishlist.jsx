    ...
    return (
        <div className="border border-solid border-[#DCDCDC] rounded-xl bg-white shadow-sm mx-[2%] md:mx-0">
            ...
            <div className="card-actions justify-start px-5 pt-10 pb-0">
                <div className="badge badge-outline bg-[#F4FCF3] border-0 text-[#23BE0A] font-semibold rounded-full">{book.tags[0]}</div>
                <div className="badge badge-outline bg-[#F4FCF3] border-0 text-[#23BE0A] font-semibold rounded-full">{book.tags[1]}</div>
            </div>
